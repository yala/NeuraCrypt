...
def inflate_model(model,
    ...
    '''
        ...
        - match_hw: Set time stride/padding/depth to match HW
...
def inflate_conv(conv2d, time_dim, time_padding,
                 time_stride, time_dilation, match_hw, center):
    '''
        args:
    ...
    if match_hw:
        time_dim = o_kernel_size[0]
        time_padding = o_padding[0]
        time_stride = o_stride[0]
        time_dilation = o_dilation[0]
